...
export const projects = [
  ...
  { id: 9, title: 'AE火焰粒子特效实景合成', category: '特效作品', tags: ['AE', '特效合成'],
    videoUrl: `${base}/特效作品/特效合成/4.mp4`,
    comparison: { after: `${base}/特效作品/特效合成/4.mp4`, before: `${base}/特效作品/原片/04.mp4` },
	    process: `${base}/过程1.png` },
  { id: 6, title: 'AE火焰粒子特效实景合成2', category: '特效作品', tags: ['AE', '特效合成'],
    videoUrl: `${base}/特效作品/特效合成/1.mp4`,
    comparison: { after: `${base}/特效作品/特效合成/1.mp4`, before: `${base}/特效作品/原片/01.mp4` },
	    process: `${base}/过程2.png` },
  { id: 7, title: 'AE火焰粒子特效实景合成3', category: '特效作品', tags: ['AE', '特效合成'],
    videoUrl: `${base}/特效作品/特效合成/2.mp4`,
    comparison: { after: `${base}/特效作品/特效合成/2.mp4`, before: `${base}/特效作品/原片/02.mp4` },
	    process: `${base}/过程3.png` },
  { id: 8, title: 'AE火焰粒子特效实景合成4', category: '特效作品', tags: ['AE', '特效合成'],
    videoUrl: `${base}/特效作品/特效合成/3.mp4`,
    comparison: { after: `${base}/特效作品/特效合成/3.mp4`, before: `${base}/特效作品/原片/03.mp4` },
